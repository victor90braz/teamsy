        ...
        @if (Route::has('login'))
            <div class="p-6 text-right sm:fixed sm:top-0 sm:right-0">
                @auth
                    ...
                    <a href="{{ route('logout') }}" class="font-semibold text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">Logout</a>
